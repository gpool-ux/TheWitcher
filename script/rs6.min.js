...
!(function(e, t) {
    ...
    e.fn.extend({
        revolution: function(a) {
            return this.each(function() {
                for (
                    var o = document.getElementsByClassName("rs-p-wp-fix");
                    o[0];
                ...
                (e.fn.revolution[s] = Y(a)),
                    ...
                    (i[s].BUG_safari_clipPath =
                        "Safari" === i.get_browser() &&
                        i.get_browser_version() > "12"),
                    (i[s].BUG_ie_clipPath =
                    ...
                    (i[s].navigation.use =
                        ...
                        ("carousel" == i[s].sliderType ||
                            ...
                            "carousel" ==
                                i[s].navigation.mouseScrollNavigation ||
        ...
        revaddcallback: function(e) {
            return this.each(function() {
                i[this.id] &&
                    (i[this.id].callBackArray === t &&
                        (i[this.id].callBackArray = []),
        ...
        e.extend(!0, i, {
            updateFixedScrollTimes: function(e) {
                !0 === i[e].sbtimeline.set &&
                    ...
                    ((i[e].sbtimeline.rest =
                        i[e].duration - i[e].sbtimeline.fixEnd),
                    (i[e].sbtimeline.time =
                        i[e].duration -
                        (i[e].sbtimeline.fixStart + i[e].sbtimeline.rest)),
                    ...
                    i[a].viewPort.visible_area.hasOwnProperty(r) &&
                        ...
                        i[a].viewPort.visible_area[r] !== t &&
                            (i[a].viewPort.vaType[r] =
                                i[a].viewPort.visible_area[r].indexOf("%") >= 0
                                    ? "%"
                                    : "px"),
            ...
            fontLoaded: function(e) {
                return (
                    (i.monoWidth =
                        i.monoWidth === t ? n("monospace") : i.monoWidth),
                    (i.sansWidth =
                        i.sansWidth === t ? n("sans-serif") : i.sansWidth),
                    (i.serifWidth =
                        i.serifWidth === t ? n("serif") : i.serifWidth),
            ...
            is_mobile: function() {
                ...
                for (var i in e)
                    e.hasOwnProperty(i) &&
                        (t =
                            !!(
                                t || navigator.userAgent.split(e[i]).length > 1
                            ) || t);
                return t;
            },
            is_android: function() {
            ...
            setSize: function(a, r) {
                var o,
                    s =
                        parseInt(i[a].top_outer || 0) +
                        parseInt(i[a].bottom_outer || 0),
                    n =
                ...
                if (
                    ((i[a].minHeight =
                        i[a].minHeight === t ? 0 : i[a].minHeight || 0),
                    (i[a].paddings =
                        i[a].paddings === t
                            ? {
                                  top:
                                      parseInt(
                                          i[a].cpar.css("paddingTop"),
                                          0
                                      ) || 0,
                                  bottom:
                                      parseInt(
                                          i[a].cpar.css("paddingBottom"),
                                          0
                                      ) || 0
                              }
                            : i[a].paddings),
                ...
                if (
                    ((g =
                        0 !== i[a].maxHeight ? Math.min(i[a].maxHeight, g) : g),
                    "fullwidth" != i[a].sliderLayout ||
                        i[a].autoHeight ||
                    ...
                    i[a].fullScreenOffset.split("%").length > 1
                        ? (f -=
                              (e(window).height() *
                                  parseInt(i[a].fullScreenOffset, 0)) /
                              100)
                        : i[a].fullScreenOffset != t &&
                    ...
                    (i[a].height = Math.round(
                        i[a].gridheight[i[a].level] *
                            (i[a].keepBPHeight
                                ? 1
                                : i[a].width / i[a].gridwidth[i[a].level])
                    )),
                        (i[a].height = Math.max(
                            d,
                            Math.max(
                ...
                if (e != t && e.length > 0)
                    for (var i = 0; i < e.length; i++) {
                        ...
                        if (
                            ...
                            new Date().getTime() - a.dataset.toggletimestamp <
                                250
                        )
                            return;
            ...
            revCheckIDS: function(a, r) {
                if (r.dataset.idcheck === t) {
                    for (; -1 != e.inArray(r.id, i[a].anyid); )
                        console.log(
                            "Warning !! Double Id in Slider " + a + ": " + r.id
                        ),
                            (r.id =
                                r.id + "_" + Math.round(9999 * Math.random()));
                    i[a].anyid.push(r.id);
                }
                r.dataset.idcheck = !0;
            }
    ...
    var a = i.is_mobile(),
        r =
            (i.is_android(),
            function(e) {
                (i[e].responsiveLevels = i.revToResp(
                    i[e].responsiveLevels,
                    i[e].rle
                )),
            ...
            for (var d in l)
                l.hasOwnProperty(d) &&
                    (l[d].dataset !== t && "on" == l[d].dataset.hsom && a
                        ...
                        : (l[d].dataset === t ||
                          (!l[d].dataset.invisible &&
                              1 != l[d].dataset.invisible)
                              ? i[r].slideamount++
                              : l[d].classList.add("not-in-nav"),
                          i[r].realslideamount++,
                          l[d].dataset !== t &&
                              ((l[d].dataset.originalindex =
                                  i[r].realslideamount),
                              (l[d].dataset.origindex =
                                  i[r].realslideamount - 1))));
        ...
        h = function(r) {
            if (i[r] !== t) {
                if (
                    ...
                    for (
                        var o = i[r].canvas.find("rs-slide:first-child")[0]
                                .dataset.firstanim,
                            s = 0;
                        s < i[r].slideamount;
                        s++
                    ...
                    )[0].dataset.firstanim = o;
                }
                for (var n in ((i[r].slides = i[
                    r
                ].canvas[0].getElementsByTagName("rs-slide")),
                ...
                i[r].slides))
                    if (i[r].slides.hasOwnProperty(n)) {
                        ...
                        (d.dataset.title =
                            d.dataset.title === t ? "" : d.dataset.title),
                            (d.dataset.description =
                                d.dataset.description === t
                                    ? ""
                                    : d.dataset.description),
                            (h.params[0] = {
                                from: RegExp("\\{\\{title\\}\\}", "g"),
                            ...
                            if (
                                ...
                                for (var _ in i[r].slides)
                                    i[r].slides.hasOwnProperty(_) &&
                                        parseInt(
                                            i[r].slides[_].dataset.origindex,
                                            0
                                        ) +
                                            1 ==
                ...
                if (
                    (i[r].forceOverflow &&
                        i[r].topc[0].classList.add("rs-forceoverflow"),
                        ...
                        i[r].c
                            ...
                            .each(function() {
                                ...
                                if (
                                    ...
                                    (n.animationonscroll =
                                        !!i[r].sbtimeline.set &&
                                        i[r].sbtimeline.layers),
                                    (n.animationonscroll =
                                        !0 === n.animationonscroll ||
                                        "true" == n.animationonscroll),
                                    (n.filteronscroll =
                                        !!i[r].scrolleffect.set &&
                                        i[r].scrolleffect.layers),
                                    (n.pxundermask =
                                        n.startclasses.indexOf("rs-pxmask") >=
                                            0 &&
                                        "off" !== i[r].parallax.type &&
                                        n.startclasses.indexOf("rs-pxl-") >= 0),
                                    (n.noPevents =
                                        n.startclasses.indexOf("rs-noevents") >=
                                        0),
                                    n.sba)
                                )
                                    for (var l in (a = n.sba.split(";")))
                                        a.hasOwnProperty(l) &&
                                            ("t" == (o = a[l].split(":"))[0] &&
                                                ...
                                                "false" == o[1] &&
                                                    (n.animOnScrollForceDisable = !0)),
                                            "e" == o[0] &&
                                                (n.filteronscroll = o[1]),
                                            "so" == o[0] &&
                                                (n.scrollBasedOffset =
                                                    parseInt(o[1]) / 1e3));
                                if (
                                    ...
                                    n.startclasses.indexOf("rs-layer-static") >=
                                        0 &&
                                    ...
                                    s.wrap(
                                        ...
                                        (!0 !== n.filteronscroll &&
                                            "true" != n.filteronscroll) ||
                                            i[r].scrolleffect._L.push(
                                                s.parent()
                                            ),
                                        (s[0].id =
                                            s[0].id === t
                                        ...
                                        "text" === n.type &&
                                            s[0].getElementsByTagName("iframe")
                                                .length > 0 &&
                    ...
                    if (isNaN(R) || R < 6)
                        ...
                        P += ">";
                        for (
                            var j = [10, 0, 4, 2, 5, 9, 0, 4, 4, 2][R - 6],
                                A = 0;
                            A < j;
                            A++
                        )
                    ...
                    i[r].c.append(i[r].loader),
                        ...
                        b(r),
                        (i[r].slides = i[r].canvas
                            .find("rs-slide")
                            .not(".rs-not-in-nav")),
                        (i[r].inli = i[r].canvas.find(
                            "rs-slide.rs-not-in-nav"
                        )),
                        ("off" !== i[r].parallax.type ||
                            i[r].scrolleffect.set ||
                            i[r].sbtimeline.set) &&
                    ...
                    (i[r].inviewport = !1),
                        ...
                        i[r].slayers.find("rs-zone").each(function() {
                            i[r].srowzones.push(e(this)),
                                this.className.indexOf("rev_row_zone_middle") >=
                                    0 && i[r].smiddleZones.push(this);
                        }),
                        "carousel" === i[r].sliderType &&
                            i.prepareCarousel &&
                    ...
                    e(window).on(N, function() {
                        if (i[r] !== t) {
                            ...
                            if ("fullscreen" == i[r].sliderLayout) {
                                ...
                                ("mobile" ==
                                    i[r].fallbacks.ignoreHeightChanges &&
                                    a) ||
                                "always" == i[r].fallbacks.ignoreHeightChanges
                                    ? ((i[r].fallbacks.ignoreHeightChangesSize =
                                          i[r].fallbacks
                                              .ignoreHeightChangesSize == t
                                              ? 0
                                              : i[r].fallbacks
                                                    .ignoreHeightChangesSize),
                                      (o =
                            ...
                            (i[r].c.outerWidth(!0) != i[r].width ||
                                i[r].c.is(":hidden") ||
                                o) &&
                                ((i[r].lastwindowheight = e(window).height()),
                                m(r));
                        }
                    }),
                        f(r),
                    ...
                    ? "fullscreen" == i[a].sliderLayout &&
                      1 == i[a].disableForceFullWidth
                        ...
                        : punchgs.TweenMax.set(i[a].canvas, {
                              ...
                              width:
                                  i[a].c.width() -
                                  i.getHorizontalOffset(i[a].c, "both")
                          })
                    : punchgs.TweenMax.set(i[a].cpar, {
                          left:
                              0 -
                              Math.ceil(
                                  i[a].c.closest("rs-fullwidth-wrap").offset()
                                      .left - r
                              ) +
                              "px",
                          width:
        ...
        m = function(a) {
            ...
            i[a].c.trigger("revolution.slide.beforeredraw"),
                1 == i[a].infullscreenmode &&
                    (i[a].minHeight = e(window).height()),
                l(a),
        ...
        b = function(a) {
            i[a].autoHeight &&
                punchgs.TweenMax.set([i[a].c, i[a].cpar], {
                    maxHeight: "none"
                }),
                punchgs.TweenMax.set(i[a].canvas, {
                    overflow: "hidden",
            ...
            for (var r = 0; r < i[a].slides.length; r++) {
                ...
                s.detach(),
                    n.detach(),
                    ((i[a].startWithSlide != t &&
                        i[a].slides[r].dataset.originalindex ==
                            i[a].startWithSlide) ||
                    ...
                    s.wrap(
                        "<rs-sbg-px><rs-sbg-wrap></rs-sbg-wrap></rs-sbg-px>"
                    );
                ...
                s.replaceWith(f),
                    ...
                    g.data(c),
                    (o[0].dataset.sba =
                        o[0].dataset.sba === t ? "" : o[0].dataset.sba);
                var m = {},
                ...
                (o[0].dataset.scrollBased =
                    !!i[a].sbtimeline.set && m.s !== t && m.s),
                    i[a].scrolleffect.set
                        ? (i[a].scrolleffect.bgs.push({
                              fade:
                                  m.f !== t
                                      ? m.f
                                      : !!i[a].scrolleffect.slide &&
                                        i[a].scrolleffect.fade,
                              blur:
                                  m.b !== t
                                      ? m.b
                                      : !!i[a].scrolleffect.slide &&
                                        i[a].scrolleffect.blur,
                              grayscale:
                                  m.g !== t
                                      ? m.g
                                      : !!i[a].scrolleffect.slide &&
                                        i[a].scrolleffect.grayscale,
                              c: l
                                  .wrap(
                                      "<rs-sbg-effectwrap></rs-sbg-effectwrap>"
                                  )
                                  .parent()
                          }),
                        ...
                        if (
                            ...
                            if (((l[d].src = g.src), "img" == g.type)) {
                                if (c.slidebgimage) {
                                    ...
                                    c.bgcolor === t
                                        ? (l[d].style.backgroundImage =
                                              'url("' + g.src + '")')
                                        : c.bgcolor !== t &&
                                          (l[d].style.background = c.bgcolor),
                                        (r.dataset.owidth = g.width),
                                        (r.dataset.oheight = g.height);
                                    var f = r.getElementsByTagName(
                                        "rs-sbg-wrap"
                                    );
                                    f.length > 0 &&
            ...
            if (i[a] !== t)
                if (
                    ...
                    if (
                        ...
                        (i[a].pr_active_slide = e(
                            i[a].slides[i[a].pr_active_key]
                        )),
                    ...
                    !0 === i[a].onlyPreparedSlide &&
                        ...
                        i[a].pr_next_slide !== t &&
                            ...
                            (i[a].pr_next_slide[0].dataset.sofacounter =
                                i[a].pr_next_slide[0].dataset.sofacounter == t
                                    ? 1
                                    : parseInt(
                                          i[a].pr_next_slide[0].dataset
                                              .sofacounter,
                                          0
                                      ) + 1),
                        i[a].stopLoop &&
                            i[a].pr_processing_key ==
                                i[a].lastslidetoshow - 1 &&
                            (i[a].c
                                .find("rs-progress")
                        ...
                        i.preLoadAudio &&
                            i.preLoadAudio(i[a].pr_next_slide, a, 1),
        ...
        j = function(a, r, o) {
            if (i[r] !== t) {
                if (
                    ((i[r].pr_active_slide = e(
                        i[r].slides[i[r].pr_active_key]
                    )),
                    (i[r].pr_next_slide = e(
                        i[r].slides[i[r].pr_processing_key]
                    )),
                    (i[r].pr_active_bg = i[r].pr_active_slide.find(
                        "rs-sbg-wrap"
                    )),
                    ...
                    (i[r].sdir =
                        i[r].pr_processing_key < i[r].pr_active_key ? 1 : 0),
                    ...
                    (i[r].mtl = new punchgs.TimelineLite({
                        ...
                        "prepared" ==
                            i[r].pr_next_slide[0].dataset.differentissplayed &&
                            ((i[r].pr_next_slide[0].dataset.differentissplayed =
                                "done"),
                    ...
                    (i[r].pr_next_slide[0].dataset.ntrid =
                        "on" == i[r].pr_next_slide[0].dataset.rndtrans
                            ...
                            : parseInt(i[r].pr_next_slide[0].dataset.ntrid, 0) +
                                  1 || 0),
                        (i[r].pr_next_slide[0].dataset.ntrid =
                            s.transition === t ||
                            i[r].pr_next_slide[0].dataset.ntrid ==
                ...
                i.scrollHandling &&
                    ...
                    punchgs.TweenMax.to(i[r].pr_next_slide, 0.001, {
                        autoAlpha: 1
                    });
            }
        };
    var A = function(r) {
            if (
                ...
                "carousel" === i[r].sliderType ||
                    ...
                    i[r].pr_next_slide.index() !=
                        i[r].pr_active_slide.index() &&
                ...
                i[r].slides[i[r].pr_active_key].dataset.sloop !== t &&
                    ...
                    i[r].c
                        ...
                        .removeClass("active-rs-slide"),
                    e(i[r].slides[i[r].pr_active_key]).addClass(
                        "active-rs-slide"
                    ),
                ...
                var o = {
                    ...
                    prevSlideLIIndex:
                        i[r].pr_lastshown_key !== t &&
                        parseInt(i[r].pr_lastshown_key, 0),
                    prevSlide:
                        i[r].pr_lastshown_key !== t &&
                        i[r].slides[i[r].pr_lastshown_key]
                };
                if (
                    ...
                    for (
                        ...
                        i[r].slides[n] !== t &&
                            ...
                            i[r].slides[n][0].dataset.originalindex ===
                                i[r].startWithSlide &&
                            (s = n);
            ...
            e(".rev_redraw_on_blurfocus").each(function() {
                ...
                1 != i[e].windowfocused &&
                    ...
                    punchgs.TweenMax.delayedCall(0.3, function() {
                        i[e].fallbacks.nextSlideOnWindowFocus &&
                            i[e].c.revnext(),
                            i[e].c.revredraw(),
                            "playing" == i[e].lastsliderstatus &&
                                i[e].c.revresume(),
                ...
                i.navigation.maintypes))
                    i.navigation.maintypes.hasOwnProperty(a) &&
                        ...
                        ((i.navigation[i.navigation.maintypes[a]].animDelay =
                            parseInt(
                                i.navigation[i.navigation.maintypes[a]]
                                    .animDelay,
                                0
                            ) / 1e3),
                ...
                if (
                    ...
                    (i.navigation.tabs.position =
                        "outer-horizontal" == i.navigation.tabs.position
                            ...
                            : i.navigation.tabs.position),
                    (i.sbtimeline.speed =
                        parseInt(i.sbtimeline.speed, 0) / 1e3 || 0.5),
                    !0 === i.sbtimeline.set &&
                    !0 === i.sbtimeline.fixed &&
                    "auto" !== i.sliderLayout
                        ? ((i.sbtimeline.fixStart = parseInt(
                              i.sbtimeline.fixStart
                          )),
                    ...
                    if ("none" !== t && t !== undefined) {
                        if (
                            ...
                            for (e in _R[id].layers[t])
                                _R[id].layers[t][e].className.indexOf(
                                    "rs-on-sh"
                                ) >= 0 &&
                        ...
                        for (e in _R[id].layers.static)
                            _R[id].layers.static[e].className.indexOf(
                                "rs-on-sh"
                            ) >= 0 &&
                                _R.renderLayerAnimation({
    ...
    (function(e) {
        ...
        jQuery.extend(!0, t, {
            prepareCarousel: function(e, o, n, l) {
                void 0 !== e &&
                    ((n = t[e].carousel.lastdirection = a(
                        n,
                        t[e].carousel.lastdirection
                    )),
                    i(e),
            ...
            organiseCarousel: function(e, i, a, r) {
                        ...
                        (d =
                            (d =
                                d > o.wrapwidth - o.inneroffset && "right" == i
                                    ? o.slide_offset -
                                      (t[e].slides.length - l) * o.slide_width
                                    : d) <
                ...
                t[e].slides &&
                    jQuery.each(t[e].slides, function(r, l) {
                        ...
                        var h =
                                "center" === o.horizontal_align
                                    ? (Math.abs(o.wrapwidth / 2) -
                                          (u.left + o.slide_width / 2)) /
                                      o.slide_width
                        ...
                        if (
                            ...
                            if (o.vary_fade)
                                ...
                                switch (o.horizontal_align) {
                                    case "center":
                                        u.autoAlpha =
                                            Math.abs(h) <
                                            Math.ceil(o.maxVisibleItems / g - 1)
                                                ? 1
                                                : 1 -
                                                  (Math.abs(h) -
                            ...
                            u.autoAlpha =
                                Math.abs(h) < Math.ceil(o.maxVisibleItems / g)
                                    ? 1
                                    : 0;
                        void 0 !== o.minScale &&
                            o.minScale > 0 &&
                    ...
                    r &&
                        ...
                        (o.oldfocused =
                            void 0 === o.oldfocused ? 0 : o.oldfocused),
                        (t[e].pr_next_key = o.focused),
                        o.focused !== o.oldfocused &&
                            t.animateTheLayers &&
                            (t.removeTheLayers(
                                jQuery(t[e].slides[o.oldfocused]),
                                e
                            ),
                            t.animateTheLayers({
                                slide: o.focused,
                                id: e,
                                mode: t[e].carousel.allLayersStarted
                                    ? "rebuild"
                                    : "start"
                            })),
                        ...
                        onComplete: function() {
                            (s.slide_globaloffset = s.infinity
                                ...
                                void 0 !== s.focused &&
                                    ...
                                    t.callingNewSlide(
                                        e,
                                        jQuery(t[e].slides[s.focused]).data(
                                            "key"
                                        ),
                                        !0
                                    ),
                                ...
                                t[e].c.trigger(
                                    "revolution.slide.carouselchange",
                                    {
                                        slider: e,
                                        slideIndex:
                                            parseInt(t[e].pr_active_key, 0) + 1,
            ...
            s = function(e) {
                ...
                if (
                    ...
                    (p = t.simp(p, t[e].slideamount, !1)),
                        (c =
                            (c = c >= 0 ? c : t[e].pr_active_key) >= 0 ? c : 0),
                        (l = d.infinity
                            ? ((i = p),
                              (a = c),
                              (r = t[e].slideamount),
    ...
    (function(e) {
        ...
        jQuery.extend(!0, i, {
                    ...
                    if (i[o].layers[s].hasOwnProperty(n)) {
                        ...
                        if (void 0 === c.dataset.initialised) {
                            ...
                            if (
                                ...
                                (g.group =
                                    "group" !== g.type &&
                                    h.closest("rs-group-wrap").length > 0
                                        ? "group"
                                        : "column" !== g.type &&
                                          h.closest("rs-column").length > 0
                                        ? "column"
                                        : "row" !== g.type &&
                                          h.closest("rs-row").length > 0
                                        ? "row"
                                        : void 0),
                                (g._lig =
                                    "group" === g.group
                                        ...
                                        : void 0),
                                (g._ligid =
                                    void 0 !== g._lig ? g._lig[0].id : void 0),
                                (g._column =
                                ...
                                (g._ingroup || g._incolumn) &&
                                    g._lig[0].className.indexOf("rs-sba") >=
                                        0 &&
                                ...
                                (g._mediatag =
                                    "html5" == g.audio ? "audio" : "video"),
                                (g.img = h.find("img")),
                                (g.deepiframe = h[0].getElementsByTagName(
                                    "iframe"
                                )),
                                (g.deepmedia = h[0].getElementsByTagName(
                                    g._mediatag
                                )),
                                (g.layertype =
                                    "image" === g.type
                                        ? "image"
                                        : h[0].className.indexOf(
                                              "rs-layer-video"
                                          ) >= 0 ||
                                          h[0].className.indexOf(
                                              "rs-layer-audio"
                                        ...
                                        : "html"),
                                g.deepiframe.length > 0 &&
                                    (g.deepiframe[0].dataset.layertype =
                                        g.layertype),
                                "column" === g.type &&
                                    ((g.cbg = g.p.find("rs-column-bg")),
                                    (g.cbgmask = g.p.find("rs-cbg-mask-wrap"))),
                                (g._slidelink =
                                    h[0].className.indexOf("slidelink") >= 0),
                                (g._isstatic =
                                    h[0].className.indexOf("rs-layer-static") >=
                                    0),
                                (g.slidekey = g._isstatic ? "staticlayers" : s),
                                (g._togglelisteners =
                                    h.find(".rs-toggled-content").length > 0),
                                (g.bgcol =
                                    void 0 === g.bgcol
                                        ? h[0].style.background.indexOf(
                                              "gradient"
                                          ) >= 0
                                ...
                                g.border))
                                    if (g.border.hasOwnProperty(t))
                                        switch (
                                            (a = g.border[t].split(":"))[0]
                                        ) {
                                            case "boc":
                                                g.bordercolor = a[1];
                                                break;
                                            case "bow":
                                                g.borderwidth = i.revToResp(
                                                    a[1],
                                                    4,
                                                    0
                                                );
                                    ...
                                    if (g.xy.hasOwnProperty(t))
                                        switch ((a = g.xy[t].split(":"))[0]) {
                                            ...
                                            case "y":
                                                ...
                                                break;
                                            case "xo":
                                                g.hoffset = a[1].replace(
                                                    "px",
                                                    ""
                                                );
                                                break;
                                            case "yo":
                                                g.voffset = a[1].replace(
                                                    "px",
                                                    ""
                                                );
                                        }
                            ...
                            (g.textalign = u(g.textalign)),
                                (g.vbility = i.revToResp(
                                    g.vbility,
                                    i[o].rle,
                                    !0
                                )),
                                (g.hoffset = i.revToResp(
                                    g.hoffset,
                                    i[o].rle,
                                    0
                                )),
                                (g.voffset = i.revToResp(
                                    g.voffset,
                                    i[o].rle,
                                    0
                                )),
                            ...
                            "slide" !== g.basealign &&
                                ...
                                (l = Math.max(
                                    ...
                                    "center" === i[o].carousel.horizontal_align
                                        ? 0 +
                                              (i[o].ulw -
                                                  i[o].gridwidth[i[o].level] *
                                                      i[o].bw) /
                                                  2
                                        : "right" ===
                                          i[o].carousel.horizontal_align
                                        ? i[o].ulw -
                                          i[o].gridwidth[i[o].level] * i[o].bw
                                        : l
                                )),
                                ...
                                if (
                                    ...
                                    -1 != h[0].className.indexOf("rs-fsv") || M
                                        ...
                                        : punchgs.TweenMax.set(h, {
                                              ...
                                              paddingBottom:
                                                  Math.round(
                                                      C.paddingBottom * i[o].bh
                                                  ) + "px",
                                              paddingLeft:
                                                  Math.round(
                                                      C.paddingLeft * i[o].bw
                                                  ) + "px",
                                              paddingRight:
                                                  Math.round(
                                                      C.paddingRight * i[o].bw
                                                  ) + "px",
                                              marginTop:
                                                  C.marginTop * i[o].bh + "px",
                                              marginBottom:
                                                  C.marginBottom * i[o].bh +
                                                  "px",
                                              marginLeft:
                                                  C.marginLeft * i[o].bw + "px",
                                              marginRight:
                                                  C.marginRight * i[o].bw +
                                                  "px",
                                              borderTopWidth:
                                                  Math.round(
                                                      C.borderTopWidth * i[o].bh
                                                  ) + "px",
                                              borderBottomWidth:
                                                  Math.round(
                                                      C.borderBottomWidth *
            ...
            animateTheLayers: function(e) {
                ...
                if (
                    ...
                    ((void 0 !== i[t].rowzones &&
                        ...
                        r >= 0 &&
                        i[t].rowzones[Math.min(r, i[t].rowzones.length)]
                            .length > 0) ||
                        (void 0 !== i[t].srowzones &&
                            i[t].srowzones.length > 0) ||
                        (void 0 !== i[t].smiddleZones &&
                            i[t].smiddleZones.length > 0)) &&
                        (i.setSize(t),
                        i.updateDimensions(t),
            ...
            renderLayerAnimation: function(e) {
                ...
                if (
                    ...
                    if (
                        ("trigger" == e.mode && (u.triggeredFrame = e.frame),
                        u._isstatic)
                    ) {
                        var x =
                    ...
                    "start" === e.mode &&
                        (e.frame =
                            void 0 === u.triggeredFrame ? 0 : u.triggeredFrame),
                    "continue" !== e.mode &&
                        "trigger" !== e.mode &&
                        void 0 !== u.timeline &&
                        u.timeline.pause(0),
                            ...
                            if (
                                ...
                                if (
                                    ("frame_999" === I &&
                                        ...
                                        u.frames[I].timeline.start >=
                                            i[c].duration &&
                                        (u.frames[I].timeline.waitoncall = !0),
                                    "start" === e.mode &&
                                        "keep" !== u.triggercache &&
                                        (u.frames[I].timeline.callstate = u
                                            .frames[I].timeline.waitoncall
                                            ? "waiting"
                                            : ""),
                                    "trigger" === e.mode &&
                                        u.frames[I].timeline.waitoncall &&
                                        (I === e.frame
                                            ? ((u.frames[
                                              ...
                                              (u.frames[I].timeline.callstate =
                                                  "called"))
                                            : (u.frames[
                                                  I
                                              ].timeline.triggered = !1)),
                                    "rebuild" === e.mode ||
                                ...
                                if (
                                    ...
                                    var S = u.frames[I],
                                        ...
                                        H = m({
                                            ...
                                            forcefilter:
                                                void 0 !==
                                                    u.frames.frame_hover &&
                                                void 0 !==
                                                    u.frames.frame_hover.filter
                                        }),
                                        N = u.fff
                                            ? m({
                                                  id: c,
                                    ...
                                    u.timeline.addLabel(I, U),
                                        ...
                                        "true" == u.animationonscroll ||
                                        1 == u.animationonscroll
                    ...
                    if (void 0 !== u.frames.loop) {
                        var G = u.frames.loop.frame_0,
                            ...
                            ae =
                                parseInt(u.frames.loop.timeline.speed, 0) / 1e3,
                            re =
                                parseInt(u.frames.loop.timeline.start) / 1e3 ||
                                0,
                            oe = re + 0.2;
                        if (
                            (K.add($, 0),
                            ...
                            var se =
                                    parseInt(
                                        u.frames.loop.timeline.radiusAngle,
                                        0
                                    ) || 0,
                                ne = [
                                    {
                                ...
                                le = {
                                    ...
                                    values: [],
                                    autoRotate:
                                        u.frames.loop.timeline.autoRotate
                                };
                            for (var de in ne)
                            ...
                            u.timeline.fromTo(
                                ...
                                $.to(
                                    u.lp,
                                    u.frames.loop.timeline.yoyo_move
                                        ? ae / 2
                                        : ae,
                                    {
                                        bezier: le,
                        ...
                        ee.to(
                            u.lp,
                            u.frames.loop.timeline.yoyo_rotate ? ae / 2 : ae,
                            {
                        ...
                        ie.to(
                            u.lp,
                            u.frames.loop.timeline.yoyo_filter ? ae / 2 : ae,
                            ce
                        ),
                            u.timeline.add(K, oe);
                    }
                    ...
                    if (
                        ...
                        if (
                            ...
                            jQuery.inArray(u.type, [
                                "group",
                                "row",
                                "column"
                            ]) >= 0 && !0 === e.updateChildren)
                        ) {
                            if (void 0 === u.childrenJS)
                                for (var F in ((u.childrenJS = {}), i[c]._L))
                                    void 0 !== i[c]._L[F]._lig &&
                                        ...
                                        i[c]._L[F]._lig[0].id !==
                                            i[c]._L[F].c[0].id &&
                                        (u.childrenJS[i[c]._L[F].c[0].id] =
                                            i[c]._L[F].c);
                            var ue =
                                void 0 === e.totime
                                    ? void 0 !==
                                      u.frames[e.frame].timeline.startAbsolute
                                        ? parseInt(
                                              u.frames[e.frame].timeline
                                                  .startAbsolute,
                                              0
                                          ) / 1e3
                                        : void 0 !==
                                          u.frames[e.frame].timeline.start
                                        ? jQuery.isNumeric(
                                              u.frames[e.frame].timeline.start
                                          )
                                            ? parseInt(
        ...
        var a = function(e) {
            ...
            o = function(e) {
                i[e.id].BUG_safari_clipPath &&
                    ...
                    (i[e.id]._L[e.L[0].id]._ingroup ||
                        ...
                        void 0 !==
                            i[e.id]._L[i[e.id]._L[e.L[0].id]._ligid].timeline &&
                        (i[e.id]._L[
                            i[e.id]._L[e.L[0].id]._ligid
                        ].timeline.isActive() ||
                            ...
                            ((null ==
                                i[e.id]._L[i[e.id]._L[e.L[0].id]._ligid]
                                    .timezone ||
                                i[e.id]._L[i[e.id]._L[e.L[0].id]._ligid]
                                    .timezone.to <=
                                    parseInt(
                ...
                a &&
                    ...
                    i[e.id]._L[e.L[0].id].p[0].classList.remove(
                        "rs-forcehidden"
                    );
                var r = {};
                (i[e.id]._L[e.L[0].id].ignoremousemove = !1),
                    ...
                    "frame_999" !== e.frame &&
                        ...
                        punchgs.TweenMax.set(i[e.id]._L[e.L[0].id].p, {
                            pointerEvents: i[e.id]._L[e.L[0].id].noPevents
                                ? "none"
                                : "auto",
                            visibility: "visible"
                        })),
            ...
            n = function(e) {
                    ...
                    r++,
                        ...
                        void 0 !== i[e.id]._L[e.L[0].id].frames[r] &&
                            ...
                            (i[e.id]._L[e.L[0].id].timezone = {
                                from: parseInt(
                                    i[e.id]._L[e.L[0].id].frames[a].timeline
                                        .startAbsolute,
                                    0
                                ),
                                to: parseInt(
                                    i[e.id]._L[e.L[0].id].frames[r].timeline
                                        .startAbsolute,
                                    0
                                )
                            });
                ...
                (o.layer = e.L),
                    ...
                    "frame_999" === e.frame &&
                        ...
                        i[e.id]._L[e.L[0].id].p[0].classList.add(
                            "rs-forcehidden"
                        )),
                    "leftstage" === o.eventtype &&
                    ...
                    void 0 !== i[e.id]._L[e.L[0].id].layerLoop &&
                        ...
                        i.renderLayerAnimation({
                            ...
                            updateChildren:
                                i[e.id]._L[e.L[0].id].layerLoop.children,
                            mode: "continue",
                            fastforward:
                                !0 === i[e.id]._L[e.L[0].id].layerLoop.keep,
                            id: e.id
                        });
            },
            l = function(e, t) {
                ...
                return (
                    ...
                    void 0 !== e &&
                        ...
                        (i.filter =
                            ...
                            "%)")),
                    (i.color =
                        void 0 === i.color ? "rgba(255,255,255,1)" : i.color),
                    (i.force3D = "auto"),
                    i.backgroundImage &&
                    ...
                    "mask" !== e.target &&
                        (void 0 === e.frame ||
                            ...
                            ((a["-webkit-filter"] =
                                ...
                                (null == e.frame.filter
                                    ? 0
                                    : e.frame.filter.blur || 0) +
                                "px) grayscale(" +
                                (null == e.frame.filter
                                    ? 0
                                    : e.frame.filter.grayscale || 0) +
                                "%) brightness(" +
                                (null == e.frame.filter
                                    ? 100
                            ...
                            (a.filter =
                                ...
                                (null == e.frame.filter
                                    ...
                                    : e.frame.filter.brightness || 100) +
                                "%)")),
                        jQuery.inArray(e.source, ["chars", "words", "lines"]) >=
                            0 &&
                            (void 0 !== e.frame[e.source].blur ||
                                e.forcefilter) &&
                            ((a["-webkit-filter"] =
                                "blur(" +
                                (parseInt(e.frame[e.source].blur, 0) || 0) +
                                "px) grayscale(" +
                                (parseInt(e.frame[e.source].grayscale, 0) ||
                                    0) +
                                "%) brightness(" +
                                (parseInt(e.frame[e.source].brightness, 0) ||
                                    100) +
                                "%)"),
                            (a.filter =
                                "blur(" +
            ...
            w = function(e, t) {
                ...
                e.ford))
                    if (e.ford.hasOwnProperty(r)) {
                        ...
                        if (e[s]) {
                            ...
                            e[s + "_mask"] &&
                                (a[s].mask = b(e[s + "_mask"], t).transform),
                                ...
                                a[s].transform.auto &&
                                    ...
                                    void 0 !== a.frame_0.filter &&
                                        (a[s].filter = jQuery.extend(
                                            !0,
                                            {},
                                            a.frame_0.filter
                                        )),
                                    void 0 !== a.frame_0.mask &&
                                        (a[s].mask = jQuery.extend(
                                            !0,
                                            {},
                                            a.frame_0.mask
                                        )),
                                    void 0 !== a.frame_0.chars &&
                                        (a[s].chars = jQuery.extend(
                                            !0,
                                            {},
                                            a.frame_0.chars
                                        )),
                                    void 0 !== a.frame_0.words &&
                                        (a[s].words = jQuery.extend(
                                            !0,
                                            {},
                                            a.frame_0.words
                                        )),
                                    void 0 !== a.frame_0.lines &&
                                        (a[s].lines = jQuery.extend(
                                            !0,
                                            {},
                                            a.frame_0.lines
                                        ))),
                ...
                return (
                    e.resetfilter &&
                        ((a.frame_0.filter = jQuery.extend(
                            !0,
                            {},
                            a.frame_0.filter
                        )),
                        ...
                        (a.frame_0.filter.grayscale =
                            void 0 === a.frame_0.filter.grayscale
                                ...
                                : a.frame_0.filter.grayscale)),
                    void 0 !== a.frame_0.filter &&
                        ((a.frame_1.filter = jQuery.extend(
                            !0,
                            {},
                            a.frame_1.filter
                        )),
            ...
            L = function(e, t, a) {
                ...
                (o.basealign = void 0 === o.basealign ? "grid" : o.basealign),
                        ...
                        (o.letterSpacing = i.revToResp(
                            n
                                ? void 0 === l.letterspacing
                                    ? parseInt(s.css("letterSpacing"), 0) ||
                                      "inherit"
                                    : l.letterspacing
                                : void 0 === o.letterspacing
                                ? parseInt(e.css("letterSpacing"), 0) ||
                                  "inherit"
                                : o.letterspacing,
                            i[a].rle
                        )),
                    ...
                    "rekursive" !== t
                        ? ((o.color = i.revToResp(
                          ...
                          (o.width = i.revToResp(
                              void 0 === o.width
                                  ? "auto"
                                  : i.smartConvertDivs(o.width),
                              i[a].rle
                          )),
                          (o.height = i.revToResp(
                              void 0 === o.height
                                  ? "auto"
                                  : i.smartConvertDivs(o.height),
                              i[a].rle
                          )),
                    ...
                    null == o.bshadow &&
                        (o.styleProps.boxShadow = e[0].style.boxShadow),
                    ("" !== o.styleProps.background &&
                        void 0 !== o.styleProps.background &&
                        o.styleProps.background !==
                            o.styleProps["background-color"]) ||
                ...
                if (
                    ("column" === o.type &&
                        punchgs.TweenMax.set(o._column, {
                            ...
                            paddingBottom:
                                Math.round(p.marginBottom * h) + "px",
                    ...
                    if (
                        (o._incolumn ||
                            ((f.marginTop =
                                "row" === o.type ? 0 : g.t * h + "px"),
                            (f.marginBottom =
                                "row" === o.type ? 0 : g.b * h + "px"),
                            (f.marginLeft =
                                "row" === o.type ? 0 : g.l * u + "px"),
                            (f.marginRight =
                                "row" === o.type ? 0 : g.r * u + "px")),
                        void 0 !== o.spike &&
                        ...
                        "column" !== o.type &&
                            ...
                            (0 !== p.borderTopWidth ||
                                ...
                                ? ((f.borderTopWidth =
                                      Math.round(p.borderTopWidth * h) + "px"),
                                  (f.borderBottomWidth =
                                      Math.round(p.borderBottomWidth * h) +
                                      "px"),
                                  (f.borderLeftWidth =
                                      Math.round(p.borderLeftWidth * u) + "px"),
                                  (f.borderRightWidth =
                                      Math.round(p.borderRightWidth * u) +
                                      "px"),
    ...
    (function(e) {
        ...
        jQuery.extend(!0, t, {
            hideUnHideNav: function(e) {
                ...
                p(a) &&
                    k(t[e].c.find(".tparrows"), a.hide_under, i, a.hide_over),
                    p(r) &&
                        k(
                            t[e].c.find(".tp-bullets"),
                            r.hide_under,
                            i,
                            r.hide_over
                        ),
            ...
            manageNavigation: function(e, i) {
                if (t[e].navigation.use) {
                    ...
                    p(t[e].navigation.bullets) &&
                        ...
                        b(
                            t[e].c.find(".tp-bullets"),
                            t[e].navigation.bullets,
                            e
                        )),
                        p(t[e].navigation.thumbnails) &&
                            b(
                                t[e].navigation.thumbnails.c,
                ...
                s(e),
                    ...
                    t[e].slides.each(function(i) {
                        if (-1 === this.className.indexOf("not-in-nav")) {
                            var a = jQuery(
                                    t[e].slides[t[e].slides.length - 1 - i]
                                ),
                                r = jQuery(this);
                            b &&
                    ...
                    t[e].c.bind(
                        ...
                        function(i) {
                            if (
                                ...
                                var a =
                                    void 0 === t[e].pr_next_key
                                        ? t[e].slides[t[e].pr_active_key]
                                              .dataset.key
                                        : t[e].slides[t[e].pr_next_key].dataset
                                              .key;
                                t[e].c.find(".tp-bullet").each(function() {
                                    ...
                                    t[e].cpar
                                        .find(".tp-thumb, .tp-tab")
                                        .each(function() {
                                            this.dataset.key === a
                                                ? (this.classList.add(
                                                      "selected"
                                                  ),
                                                  "RS-TAB" === this.nodeName
                                                      ? r(v, e)
                                                      : r(f, e))
                                ...
                                if (!0 === o.enable) {
                                    ...
                                    if (
                                        ...
                                        return;
                                    jQuery.each(t[e].thumbs[d].params, function(
                                        e,
                                        t
                                    ) {
                                        c = c.replace(t.from, t.to);
                        ...
                        t[e].cpar.hasClass("tp-mouseover") ||
                            ...
                            t[e].firstSlideAvailable &&
                                ...
                                i &&
                                    ...
                                    (t[e].hideAllNavElementTimer = setTimeout(
                                        function() {
                                            t[e].cpar.removeClass(
                                                "tp-mouseover"
                                            ),
                                                g(e);
                                        },
        ...
        var r = function(e, i) {
                var a =
                        "vertical" === e.direction
                            ? e.mask
                                  .find(e.single)
                                  .first()
                                  .outerHeight(!0) + e.space
                            : e.mask
                                  .find(e.single)
                                  .first()
                                  .outerWidth(!0) + e.space,
                    r =
                        "vertical" === e.direction
                            ? e.mask.height()
                            : e.mask.width(),
            ...
            o = function(e, t, i, a, r, o) {
                var s = i.parent().find(".tp-" + o + "s"),
                    ...
                    l = s.find(".tp-" + o + "-mask"),
                    d =
                        a.width * e < a.min_width
                            ? a.min_width
                            : Math.round(a.width * e),
                ...
                !0 === t[e].navigation.keyboardNavigation &&
                    jQuery(document).keydown(function(i) {
                        (("horizontal" == t[e].navigation.keyboard_direction &&
                            ...
                            (("horizontal" ==
                                t[e].navigation.keyboard_direction &&
                                37 == i.keyCode) ||
                                ("vertical" ==
                                    t[e].navigation.keyboard_direction &&
                                    38 == i.keyCode)) &&
            ...
            n = function(e) {
                if (
                    ...
                    (t[e].isIEEleven = !!navigator.userAgent.match(
                        /Trident.*rv\:11\./
                    )),
                        (t[e].isSafari = !!navigator.userAgent.match(
                            /safari/i
                        )),
                        (t[e].ischrome = !!navigator.userAgent.match(
                            /chrome/i
                        ));
                    var i = t[e].ischrome
                            ? -49
                    ...
                    t[e].c.on("mousewheel DOMMouseScroll", function(r) {
                        var o,
                            ...
                            c =
                                ...
                                l && !s && (s = l < 1 ? -1 : 1),
                                d && !n && (n = d < 1 ? -1 : 1),
                                ((d = navigator.userAgent.match(/mozilla/i)
                                    ? 10 * d
                                    : d) > 300 ||
                                    d < -300) &&
                                    (d /= 10),
                    ...
                    s.swipetp({
                        ...
                        swipeStatus: function(r, s, n, c, p, u, h) {
                            ...
                            if (
                                ...
                                var b = t[a].dragStartedOverThumbs
                                        ? ".tp-thumbs"
                                        : ".tp-tabs",
                                ...
                                var T = e.parent().find(w),
                                    ...
                                    S =
                                        "vertical" === R
                                            ? T.find(x)
                                                  .first()
                                                  .outerHeight(!0) + k.space
                                            : T.find(x)
                                                  .first()
                                                  .outerWidth(!0) + k.space,
                                    M =
                                        ...
                                        if (v)
                                            return (
                                                ...
                                                setTimeout(function() {
                                                    (t[
                                                        a
                                                    ].dragStartedOverSlider = !1),
                                                        (t[
                                                            a
                                                        ].dragStartedOverThumbs = !1),
                                                        (t[
                                                            a
                                                        ].dragStartedOverTabs = !1);
                                                }, 100),
                                                e
                                                    .parent()
                                                    .find(b)
                ...
                for (var o in r)
                    r.hasOwnProperty(o) &&
                        ...
                        (t[e].navigation[r[o]].hideCall = setTimeout(
                            ...
                            i
                                ? parseInt(
                                      t[e].navigation[r[o]].hide_delay_mobile,
                                      0
                                  )
            ...
            m = function(e, i) {
                (e.style = void 0 === e.style ? "" : e.style),
                    (e.left.style =
                        void 0 === e.left.style ? "" : e.left.style),
                    (e.right.style =
                        void 0 === e.right.style ? "" : e.right.style),
                ...
                e.rtl
                    ...
                    (e.padding_top = parseInt(
                        t[i].carousel.padding_top || 0,
                        0
                    )),
                    (e.padding_bottom = parseInt(
                        t[i].carousel.padding_bottom || 0,
                        0
                    )),
                    b(a, e.left, i),
                    b(r, e.right, i),
                    ...
                    s =
                        "layergrid" == i.container
                            ? "fullscreen" == t[a].sliderLayout
                                ? t[a].height / 2 -
                                  (t[a].gridheight[t[a].level] * t[a].bh) / 2
                                : t[a].autoHeight ||
                    ...
                    o =
                        "layergrid" == i.container
                            ? "carousel" === t[a].sliderType
                                ? 0
                                : t[a].width / 2 -
                                  (t[a].gridwidth[t[a].level] * t[a].bw) / 2
                            : 0,
                    s =
                        "left" === i.h_align
                            ? {
            ...
            w = function(e, i, a, r) {
                ...
                var l = e.find(".justaddedbullet"),
                    ...
                    c =
                        l.outerWidth() +
                        parseInt(void 0 === i.space ? 0 : i.space, 0),
                    p =
                        l.outerHeight() +
                        parseInt(void 0 === i.space ? 0 : i.space, 0);
                "vertical" === i.direction
                    ...
                    (i.padding_top = parseInt(
                        t[r].carousel.padding_top || 0,
                        0
                    )),
                    (i.padding_bottom = parseInt(
                        t[r].carousel.padding_bottom || 0,
                        0
                    )),
                    ("outer-left" != i.position &&
                        "outer-right" != i.position) ||
            ...
            _ = function(e, i, a, r, o) {
                ...
                if (
                    ...
                    "outer-top" === i.position
                        ...
                        ("outer-left" !== i.position &&
                            "outer-right" !== i.position) ||
                            punchgs.TweenLite.set(t[o].c, {
                                overflow: "visible"
                            }),
                        (i.padding_top = parseInt(
                            t[o].carousel.padding_top || 0,
                            0
                        )),
                        (i.padding_bottom = parseInt(
                            t[o].carousel.padding_bottom || 0,
                            0
                        )),
                        ("outer-left" != i.position &&
                            "outer-right" != i.position) ||
                ...
                var h = a.data("key"),
                    ...
                    v =
                        "horizontal" === i.direction
                            ? i.width * i.visibleAmount +
                              i.space * (i.visibleAmount - 1)
                            : i.width,
                    y =
                        "horizontal" === i.direction
                            ? i.height
                            : i.height * i.visibleAmount +
                              i.space * (i.visibleAmount - 1),
                    w = i.tmp;
                ...
                if (void 0 !== r.panzoom && null !== r.panzoom) {
                    ...
                    var p = e.data("pzimg"),
                        ...
                        h = (function(e, t, i) {
                                                      ...
                                                      if (t.hasOwnProperty(a)) {
                                                          ...
                                                          switch (o) {
                                                              ...
                                                              case "se":
                                                                  ...
                                                                  break;
                                                              case "rs":
                                                                  i.rotatestart = parseInt(
                                                                      s,
                                                                      0
                                                                  );
                                                                  break;
                                                              case "re":
                                                                  i.rotateend = parseInt(
                                                                      s,
                                                                      0
                                                                  );
                                                                  break;
                                                              case "bs":
                                                                  i.blurstart = parseInt(
                                                                      s,
                                                                      0
                                                                  );
                                                                  break;
                            ...
                            return (
                                (r[0] =
                                    r[0] > 0 ? 0 : d + r[0] < e ? e - d : r[0]),
                                (o[0] =
                                    o[0] > 0 ? 0 : u + o[0] < e ? e - u : o[0]),
                                (r[1] =
                                    r[1] > 0 ? 0 : p + r[1] < t ? t - p : r[1]),
                                (o[1] =
                                    o[1] > 0 ? 0 : h + o[1] < t ? t - h : o[1]),
                                (s.starto.x = r[0] + "px"),
                                (s.starto.y = r[1] + "px"),
                                (s.endo.x = o[0] + "px"),
                                (s.endo.y = o[1] + "px"),
                    ...
                    if (
                        ...
                        (r.panvalues.duration =
                            NaN === r.panvalues.duration ||
                            void 0 === r.panvalues.duration
                                ? 10
                                : r.panvalues.duration),
                        g.add(
                            punchgs.TweenLite.fromTo(
        ...
        jQuery.extend(!0, t, {
            checkForParallax: function(e) {
                ...
                if (!a.done) {
                    ...
                    t[e].slides.each(function() {
                        ...
                        (a.speed =
                            void 0 === a.speed ? 0 : parseInt(a.speed, 0)),
                        (a.speedbg =
                            void 0 === a.speedbg ? 0 : parseInt(a.speedbg, 0)),
                        (a.speedls =
                            void 0 === a.speedls ? 0 : parseInt(a.speedls, 0)),
                        t[e].c
                    ...
                    ("mouse" != a.type &&
                        ...
                        (t[e].c.mouseenter(function(i) {
                            ...
                            void 0 !== t[e].pr_active_key &&
                                ((t[e].slides[
                                    t[e].pr_active_key
                                ].dataset.enterx = i.pageX - r),
                                (t[e].slides[
                                    t[e].pr_active_key
                                ].dataset.entery = i.pageY - a));
                        }),
                        t[e].c.on(
                            ...
                            function(i, r) {
                                ...
                                if ("enterpoint" == a.origo) {
                                    var s = t[e].c.offset().top,
                                        n = t[e].c.offset().left;
                                    null == o.data("enterx") &&
                                        o.data("enterx", i.pageX - n),
                                        null == o.data("entery") &&
                                            o.data("entery", i.pageY - s);
                        ...
                        i &&
                            (window.ondeviceorientation = function(i) {
                                ...
                                if (
                                    ...
                                    t[e].c
                                        .find(
                                            "rs-static-layers .tp-parallax-container"
                                        )
                                        .each(function() {
                                            h.push(jQuery(this));
                                        }),
                    ...
                    s.set &&
                        ((s.multiplicator_layers = parseFloat(
                            s.multiplicator_layers
                        )),
            ...
            scrollHandling: function(e, a, r, o) {
                if (void 0 !== t[e]) {
                    ...
                    var c =
                        ...
                        p = t[e].fixedOnTop
                            ? Math.min(
                                  ...
                                  Math.max(
                                      0,
                                      window.scrollY / t[e].lastwindowheight
                                  )
                              )
                            : Math.min(
                                  1,
                    ...
                    (t[e].scrollproc = c),
                        t.callBackHandling &&
                            t.callBackHandling(e, "parallax", "start");
                    ...
                    if (
                        ...
                        n.enable &&
                            (void 0 === t[e].viewPort.vaType &&
                                t.updateVisibleArea(e),
                            ("%" === n.vaType[t[e].level] &&
                    ...
                    t.callBackHandling &&
                        t.callBackHandling(e, "parallax", "end");
                }
            }
        });
    })(jQuery),
        ...
        var i = function(e, t) {
            ...
            a = function(e) {
                var a = e.id,
                    ...
                    n =
                        ...
                        (s.nTR < 11 ||
                            ...
                            : s.nTR;
                !0 !== e.recall
                    ? ((t[a].lastSliderAnimation = jQuery.extend(
                          !0,
                          {},
                          e.animation
                      )),
                      (t[a].lastSliderTransition = jQuery.extend(!0, {}, s)))
                    : (e.animation = jQuery.extend(
                          !0,
                          {},
                          t[a].lastSliderAnimation
                      ));
                ...
                (d =
                    ...
                    (t[a].rotate =
                        ...
                        "d" == t[a].rotate
                            ...
                            : t[a].rotate),
                    (t[a].rotate =
                        window._rs_ie || window._rs_ie9 ? 0 : t[a].rotate),
                    (n < 11 ||
                        16 === n ||
                        17 === n ||
                        18 === n ||
                        ...
                        (t[a].slots =
                            t[a].slots < 1
                                ...
                                : t[a].slots),
                        (t[a].slots =
                            (4 == n || 5 == n || 6 == n) && t[a].slots < 3
                                ? 3
                                : t[a].slots),
                        (t[a].slots =
                            0 != s.TR[3]
                                ? Math.min(t[a].slots, s.TR[3])
                                : t[a].slots),
                        (t[a].slots =
                            9 == n
                                ? t[a].width / t[a].slots
                        ...
                        (t[a].slots =
                            ...
                            "vertical" !== s.TR[4]
                                ...
                                : t[a].slots + 2),
                        null != s.TR[6] &&
                            r(t[a].pr_active_bg, a, s.TR[6], s.TR[4]),
                        null != s.TR[5] &&
                            r(t[a].pr_next_bg, a, s.TR[5], s.TR[4]),
                        t[a].mtl.delay(0.075));
                var c =
                        7 === n || 16 === n || 8 === n || 17 === n || 18 === n
                            ? 0
                            : 1,
                ...
                if (
                    ...
                    t[a].pr_next_bg.find(".slotslide").each(function(e) {
                        t[a].mtl.add(
                            punchgs.TweenLite.from(
                                this,
                                (Math.random() * d + 300) / 1e3,
                                {
                                    autoAlpha: 0,
                                    force3D: "auto",
                                    rotation: t[a].rotate,
                    ...
                    for (
                        var y = t[a].pr_next_bg[0].getElementsByClassName(
                                "slotslide"
                            ),
                            b = d - d / 1.8,
                            w = 0;
                    ...
                    switch (s.trC) {
                        ...
                        case 4:
                            t[a].mtl.add(
                                punchgs.TweenLite.set(
                                    t[a].pr_active_bg.parent(),
                                    { backgroundColor: _, force3D: "auto" }
                                ),
                                0
                            ),
                                t[a].mtl.add(
                                    punchgs.TweenLite.set(
                                        t[a].pr_next_bg.parent(),
                                        {
                                            backgroundColor: "transparent",
                                            force3D: "auto"
                                        }
                        ...
                        case 12:
                            var x =
                                    ...
                                    (jQuery.inArray(s.trC, [9, 10]) >= 0
                                        ...
                                        : 0) +
                                    "px) grayscale(" +
                                    (jQuery.inArray(s.trC, [5, 6, 7, 8]) >= 0
                                        ? 100
                                        : 0) +
                                    "%) brightness(" +
                                    (jQuery.inArray(s.trC, [7, 8]) >= 0
                                        ? 300
                                        : 0) +
                                    "%)",
                    ...
                    var T = 3 == s.trC ? d / 1300 : d / 1e3,
                        ...
                        S =
                            13 == n
                                ...
                                : 0,
                        M =
                            1 == s.trC || 2 == s.trC || 5 == s.trC || 6 == s.trC
                                ? 0
                                : 1,
                        O =
                            4 == s.trC || 5 == s.trC
                    ...
                    if (
                        ...
                        8 == s.trC
                            ? (t[a].mtl.add(
                                  punchgs.TweenLite.set(t[a].pr_active_slide, {
                                      zIndex: 20
                                  }),
                                  0
                              ),
                              t[a].mtl.add(
                                  punchgs.TweenLite.set(t[a].pr_next_slide, {
                                      zIndex: 15
                                  }),
                                  0
                              ),
                    ...
                    (Y[G] = "0px"),
                        ...
                        t[a].mtl.add(
                            punchgs.TweenLite.fromTo(Q, d / 1e3, E, Z),
                            0
                        ),
                        t[a].mtl.add(
                            punchgs.TweenLite.fromTo(
                                Q.find(".slotslide div"),
                                d / 1e3,
                                q,
                                U
                            ),
            ...
            r = function(e, i, a, r) {
                ...
                null != o.data("currotate") && (l = o.data("currotate")),
                    null != o.data("curscale") && "box" == r
                        ...
                        : null != o.data("curscale") &&
                          (n = o.data("curscale")),
                    (function(e, i) {
                        (t[i].slotw = Math.ceil(t[i].width / t[i].slots)),
                            "fullscreen" == t[i].sliderLayout
                                ? (t[i].sloth = Math.ceil(
                                      jQuery(window).height() / t[i].slots
                                  ))
                                : (t[i].sloth = Math.ceil(
                                      t[i].height / t[i].slots
                                  )),
                            t[i].autoHeight &&
                                void 0 !== e &&
                                "" !== e &&
    ...
    (function(e) {
        ...
        function a(e) {
            return null == e
                ...
                ? e
                : e.split(":").length > 1
                ? 60 * parseInt(e.split(":")[0], 0) +
                  parseInt(e.split(":")[1], 0)
                : e;
        }
        jQuery.extend(!0, t, {
                ...
                switch (s.type) {
                    ...
                    case "vimeo":
                        void 0 !== s.vimeoplayer &&
                            ...
                            (s.ssec >= 0 &&
                                s.vimeoplayer.setCurrentTime(s.ssec),
                            s.vimeoplayer.pause()),
                            0 != e.find("rs-poster").length ||
                                s.bgvideo ||
                                "preset" === r ||
            ...
            Mute: function(e, i, a) {
                ...
                switch (o.type) {
                    ...
                    case "html5":
                        (o.video.volume =
                            o.volcache >= 1 ? o.volcache / 100 : o.volcache),
                                  ...
                                  ? setTimeout(function() {
                                        var r =
                                            void 0 === a.currenttime
                                                ...
                                                : a.currenttime;
                                        a.nseTriggered &&
                                            ((r = -1), (a.nseTriggered = !1)),
                                            -1 != a.ssec &&
                                                a.ssec > r &&
                                                a.vimeoplayer.setCurrentTime(
                                                    a.ssec
                                                ),
                                            ("mute" == a.volume ||
                                                0 === a.volume ||
            ...
            manageVideoLayer: function(e, a) {
                ...
                if (i && o.opom)
                    ...
                    switch (
                        ...
                        case "youtube":
                            o.controls ||
                                ((o.vatr = o.vatr.replace(
                                    "controls=1",
                                    "controls=0"
                                )),
                                -1 ==
                                    o.vatr.toLowerCase().indexOf("controls") &&
                    ...
                    if (
                        !(null != o.poster && o.poster.length > 2) ||
                        (i && o.npom)
                    ) {
                    ...
                    "none" !== o.doverlay &&
                        ...
                        e.append(
                            '<rs-dotted class="' + o.doverlay + '"></rs-dotted>'
                        ),
        ...
        var r = function(e, t, i) {
            ...
            s = function(e, i) {
                ...
                (a.bgvideo || a.fcover) &&
                    (a.fcover &&
                        i.removeClass("rs-fsv").addClass("coverscreenvideo"),
            ...
            n = function(e, t) {
                ...
                i.getPaused()
                    ...
                    .catch(function() {
                        console.log(
                            "Get Paused Function Failed for Vimeo Volume Changes"
                        );
                    });
            },
            l = function(e, t) {
            ...
            v = function(e) {
                ...
                return (
                    ...
                    void 0 !== e.videoattributes &&
                        (i.vatr = e.videoattributes),
            ...
            b = function(e, i) {
                void 0 !== t[i] &&
                    ...
                    t[i].playingvideos.splice(
                        jQuery.inArray(e, t[i].playingvideos),
                        1
                    );
            };
    })(jQuery);
